...
const _objd SDO8001[] =
{
  {0x0, DTYPE_UNSIGNED8,     	 8, ATYPE_RO,   Number_of_elements,   7, 0},
  {0x1, DTYPE_VISIBLE_STRING,   64, ATYPE_RO,   "bl_ver",   	0, &sdo.ram.bl_ver},
  {0x2, DTYPE_UNSIGNED16,   	16, ATYPE_RW, 	"ctrl_cmd",  	0, &sdo.ram.ctrl_cmd},
  {0x3, DTYPE_UNSIGNED16,   	16, ATYPE_RO, 	"ctrl_cmd_ack", 0, &sdo.ram.ctrl_cmd_ack},
  {0x4, DTYPE_UNSIGNED16,   	16, ATYPE_RW, 	"flash_cmd",  	0, &sdo.ram.flash_cmd},
  {0x5, DTYPE_UNSIGNED16,   	16, ATYPE_RO, 	"flash_cmd_ack",0, &sdo.ram.flash_cmd_ack},
  {0x6, DTYPE_UNSIGNED32,   	32, ATYPE_RO, 	"flash_crc",  	0, &sdo.ram.crc_app},
