...
#define FLASH_APP_NSECTORS	1 // sector 5
#define FLASH_APP_BSIZE		128*1024 // 0x20000


#define FLASH_PAR_ADDR		0x800C000 // sector 3
#define FLASH_PAR_SECTOR	FLASH_SECTOR_3
#define FLASH_PAR_NSECTORS	1
#define FLASH_PAR_BSIZE		16*1024 // 0x4000

#define FLASH_CAL_ADDR		0x8010000 // sector 4
#define FLASH_CAL_SECTOR	FLASH_SECTOR_4
#define FLASH_CAL_NSECTORS	1
#define FLASH_CAL_BSIZE		64*1024 // 0x10000
