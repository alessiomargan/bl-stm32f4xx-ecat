...
#define TOGLLE_RED	HAL_GPIO_TogglePin(LED_1_GPIO_Port, LED_1_Pin)
#define TOGLLE_GRN	HAL_GPIO_TogglePin(LED_2_GPIO_Port, LED_2_Pin)
#define GRN_ON 		HAL_GPIO_WritePin(LED_2_GPIO_Port, LED_2_Pin, GPIO_PIN_SET)
#define GRN_OFF 	HAL_GPIO_WritePin(LED_2_GPIO_Port, LED_2_Pin, GPIO_PIN_RESET)
